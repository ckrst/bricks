...
docker exec brix_db mysql -uroot -pchangeme brix < /vagrant/vagrant/db/init.sql
docker exec brix_db mysql -uroot -pchangeme test_brix < /vagrant/vagrant/db/init.sql
